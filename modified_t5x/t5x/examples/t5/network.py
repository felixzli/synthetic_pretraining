...
class T5Config:
  ...
  # 
  is_load_embed: bool = False
  t5_small_t5x_checkpoint_path: str = 'aslkdmaslkdmaslk'
  is_sanity_check_load_weights:bool=False
  is_load_everything_but_embed:bool=False
  is_load_second_everything_but_embed:bool=False
  second_t5_small_t5x_checkpoint_path: str='askjdnaskjndkjasndkjsand'
  is_load_t5_small_to_first_blocks:bool=False
  is_init_with_statistics:bool=None
  is_only_load_relpos_embed:bool=None
  is_only_load_relpos_embed_with_statistics:bool=None

  #####
  is_load_all_except_relpos:bool=None
  is_load_with_all_stats:bool=None
  is_load_with_layer_stats:bool=None
  ###

  #####
  is_init_with_per_layer_attention_std:bool=None
  ###

  ###
  # 2/16
  is_init_with_relpos_mean_std:bool=None
  is_init_with_token_mean_std:bool=None
  is_init_with_per_layer_attention_mean_std:bool=None
  is_init_with_per_QKVO_mean_std:bool=None

  ###
  # 2/18
  is_init_with_per_mlp_mean_std:bool=None
  is_init_with_per_layer_norm_mean_std:bool=None

  ###
  # 2/23
  is_init_with_per_layer_norm_std:bool=None
  is_init_with_per_QKVO_std:bool=None
  is_init_with_relpos_std:bool=None

  ####
  # mar 4
  which_mar4_params_to_init_mean_std:str=None


  ####
  # mar 7:::: mar 4 init but ONLY std
  which_mar7_params_to_init_std:str=None


  #####
  #
  which_params_to_init_mean:str=None

  #####
  init_with_custom_std:str=None
  init_with_custom_value:str=None
  ###
  is_init_param_std_across_layers_and_layer_norm_scale_mean_across_layers:bool=False
  is_init_per_param_std_and_layer_norm_scale_mean:bool=False

  is_init_per_layer_grouping:bool=False
  is_init_per_layer_across_layer_grouping:bool=False
  sanity_flag:bool=True
