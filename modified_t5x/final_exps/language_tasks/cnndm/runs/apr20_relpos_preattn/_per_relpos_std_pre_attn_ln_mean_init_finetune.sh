...
mean_only_params=pre_self_attn_ln-pre_cross_attn_ln
mar7params=enc_relpos-dec_relpos
...
--gin.which_params_to_init_mean="'$mean_only_params'" \
--gin.which_mar7_params_to_init_std="'$mar7params'" \
