...
finetune_bash_file = 'final_exps/language_tasks/cnndm/runs/pre_attn_ln_value_sweep/depth100/_set_pre_attn_ln_value.sh'

pre_attn_ln_values=[0.1, 0.2, 0.4, 0.6, 0.8]
idk=sys.argv[1]
vm=sys.argv[2]
