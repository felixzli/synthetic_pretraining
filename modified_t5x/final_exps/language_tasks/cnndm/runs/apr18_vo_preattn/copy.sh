...
--exp_suffix $parent_dir_basename \
--pretrain_id $file_path_no_ext_basename \
--vm 5 \
--idk $1 --finetune_bash_file ${_parent_parent_parent_dir}/_per_vo_std_pre_attn_ln_mean_init_finetune.sh
