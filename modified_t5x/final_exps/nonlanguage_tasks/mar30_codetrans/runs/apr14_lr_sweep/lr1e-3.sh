...
cp -r /mnt/disks/persist/t5_training_models/final_exps/nonlanguage_tasks/mar30_codetrans/from_scratch/share_embed_apr1_first_try /mnt/disks/persist/t5_training_models/final_exps/nonlanguage_tasks/mar30_codetrans/from_scratch/lr1e-3_apr14_lr_sweep
